...
<section class="hero-section text-center">
    <div class="container">
        ...
        <p class="lead mb-5">
            Calculez le coût de vos démarches administratives en fonction du type d'acte, du lieu et du mode de paiement
        </p>
    </div>
</section>
            ...
            <div class="col-lg-10">
                <div class="card shadow">
                    <div class="card-header bg-light py-3">
                        <h2 class="fs-4 mb-0 text-center"><i class="fas fa-calculator me-2 text-success"></i>Calculateur de Tarifs</h2>
                    </div>
                    <div class="card-body p-4">
                                    ...
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <select class="form-select" id="typeActe" name="typeActe" required>
                                                <option value="" selected disabled>Sélectionnez un type d'acte</option>
                                                ...
                                                <option value="1500">Légalisation de document - 1500 FCFA</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <label for="service" class="form-label">
                                                <i class="fas fa-building me-2 text-success"></i>Service administratif
                                            </label>
                                    ...
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <select class="form-select" id="modePaiement" name="modePaiement" required>
                                                ...
                                                <option value="0">TresorMoney (Frais: 100 FCFA)</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" class="btn btn-outline-secondary" id="decrementCopies">
                                                    <i class="fas fa-minus"></i>
                                                </button>
                                                <input type="number" class="form-control mx-2 text-center" id="nombreCopies" name="nombreCopies" value="1" min="1" max="10" required>
                                                <button type="button" class="btn btn-outline-secondary" id="incrementCopies">
                            ...
                            <div class="card border-success">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                                    <span>Lieu de demande:</span>
                                                    <span id="resultLieu" class="fw-bold"></span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-md-6">
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                                    ...
                                                    <span id="resultDelai" class="fw-bold"></span>
                                                </li>
                                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="text-center mt-4">
                                        ...
                                        <button type="button" class="btn btn-outline-secondary ms-2" id="newCalculation">
                        ...
                        <div class="alert alert-info mt-4">
                            ...
                            <ul class="mb-0">
                                ...
                                <li>Des majorations peuvent s'appliquer selon le service administratif choisi (mairie, préfecture, etc.)</li>
                                ...
                                <li>Les tarifs affichés sont donnés à titre indicatif et peuvent être soumis à modification</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="alert alert-warning mt-4">
            ...
            <strong>Note importante:</strong> Les tarifs peuvent varier selon les localités et sont susceptibles d'être modifiés par les autorités compétentes. Veuillez vous référer aux affichages officiels dans les administrations concernées pour les tarifs en vigueur.
        </div>
    </div>
</section>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const resultLieu = document.getElementById('resultLieu');
        const resultDelai = document.getElementById('resultDelai');
        ...
        calculatorForm.addEventListener('submit', function(e) {
            ...
            const delaiTraitementSelect = document.getElementById('delaiTraitement');

            const prixBase = parseInt(typeActeSelect.value);
            const serviceMultiplier = parseFloat(serviceSelect.value);
            const lieuMultiplier = parseFloat(lieuSelect.value);
            const fraisPaiement = parseInt(modePaiementSelect.value);
            const delaiMultiplier = parseFloat(delaiTraitementSelect.value);
            const nombreCopies = parseInt(nombreCopiesInput.value);

            // Calcul du prix total
            const prixTotal = (prixBase * serviceMultiplier * lieuMultiplier * delaiMultiplier * nombreCopies) + fraisPaiement;
            ...
            resultLieu.textContent = lieuSelect.options[lieuSelect.selectedIndex].text;
            resultDelai.textContent = delaiTraitementSelect.options[delaiTraitementSelect.selectedIndex].text;
