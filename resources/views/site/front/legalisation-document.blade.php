            ...
            <div class="card shadow">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form>
                        ...
                        <div class="mb-3">
                            <label for="motif_legalisation" class="form-label">Motif de la légalisation *</label>
                            <div class="input-group">
                                <span class="input-group-text">
                                    <i class="fas fa-info-circle"></i>
                                </span>
                                <textarea class="form-control" id="motif_legalisation" rows="3" placeholder="Précisez le motif de votre demande de légalisation" required></textarea>
                            </div>
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (form.checkValidity()) {
                ...
                const serviceName = "Légalisation de document";
                const amount = "5000"; // Montant en FCFA
