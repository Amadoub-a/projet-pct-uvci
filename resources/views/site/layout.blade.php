        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item ms-lg-3">
                    <a class="btn btn-outline-success {{ Route::currentRouteName() === 'sign-in' ? 'active' : '' }}" href="{{ route(name: 'sign-in') }}">Se connecter</a>
                </li>
                <li class="nav-item ms-lg-2">
                    <a class="btn btn-outline-primary {{ Route::currentRouteName() === 'sign-up' ? 'active' : '' }}" href="{{ route(name: 'sign-up') }}">S'inscrire</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2">
                        <a href="{{ route(name: 'declaration-naissance') }}" class="text-white text-decoration-none"
                        >Acte de naissance</a
                        >
                    </li>
                    <li class="mb-2">
                        <a href="{{ route(name: 'declaration-mariage') }}" class="text-white text-decoration-none"
                        >Acte de mariage</a
                        >
                    </li>
                    <li class="mb-2">
