...
use App\Models\CertificatVie;

class CertificatVieController extends Controller
{
    public function storeCertificatVie(Request $request){
        $request->validate([
